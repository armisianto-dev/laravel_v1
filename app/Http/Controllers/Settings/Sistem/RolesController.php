...
class RolesController extends DeveloperBase
{
  ...
  public function index(Request $request){
    ...
    $rs_result = RolesModel::whereRaw('group_name LIKE ? ', [$group_name])
      ->orderBy('group_id', 'ASC')
      ->paginate(10);
    return view('Settings.Sistem.Roles.index', compact('rs_result','search'));
  }
  ...
  public function create(){
    ...
    return view('Settings.Sistem.Roles.create');
  }
  ...
  public function insert(Request $request){
    ...
    if($validator->fails()){
      ...
      return redirect('/sistem/roles/create')->with('error','Data group gagal ditambahkan')->withErrors($messages);
    }
    ...
    if(RolesModel::create([
      ...
      'mdb' => $this->com_user['user_id']
        ...
        return redirect('/sistem/roles/create')->with('success','Data group berhasil ditambahkan');
      }

      return redirect('/sistem/roles/create')->with('error','Data group gagal ditambahkan');
    }
