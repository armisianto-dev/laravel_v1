  ...
  <div id="navbar-container" class="boxed">
    ...
    <div class="navbar-header">
      <a href="index.html" class="navbar-brand">
        <img src="{{ URL::asset('assets/themes/default/img/laravel-logo.png') }}" alt="Laravel Logo" class="brand-icon">
        <div class="brand-title">
          <span class="brand-text">Laravel V1</span>
        </div>
      </a>
    </div>
    <!--================================-->
              ...
              <div class="nano-content">
                <ul class="head-list">
                  ...
                  <li class="bg-gray">
                    <a class="media" href="#">
                      <div class="media-left">
                        <img class="img-circle img-sm" alt="Profile Picture" src="../doc/images/profile-photos/9.png">
                      </div>
                      <div class="media-body">
                  ...
                  <li class="bg-gray">
                    <a class="media" href="#">
                      <div class="media-left">
                        <img class="img-circle img-sm" alt="Profile Picture" src="../doc/images/profile-photos/3.png">
                      </div>
                      <div class="media-body">
          ...
          <div class="dropdown-menu mega-dropdown-menu">
            <div class="row">
              ...
              <div class="col-sm-4 col-md-3">
                ...
                <p class="pad-top mar-top bord-top text-sm">Lorem ipsum dolor sit amet, consectetuer adipiscing
              ...
              <div class="col-sm-12 col-md-3">
                ...
                <ul class="list-unstyled list-inline text-justify">
                  ...
                  <li class="pad-btm">
                    <img src="../doc/images//thumbs/mega-menu-2.jpg" alt="thumbs">
                  </li>
                  <li class="pad-btm">
                    <img src="../doc/images//thumbs/mega-menu-3.jpg" alt="thumbs">
                  </li>
                  <li class="pad-btm">
                    <img src="../doc/images//thumbs/mega-menu-1.jpg" alt="thumbs">
                  </li>
                  <li class="pad-btm">
                    <img src="../doc/images//thumbs/mega-menu-4.jpg" alt="thumbs">
                  </li>
                  <li class="pad-btm">
                    <img src="../doc/images//thumbs/mega-menu-5.jpg" alt="thumbs">
                  </li>
                  <li class="pad-btm">
                    <img src="../doc/images//thumbs/mega-menu-6.jpg" alt="thumbs">
                  </li>
                </ul>
        ...
        <li class="dropdown">
          <a id="demo-lang-switch" class="lang-selector dropdown-toggle" href="#" data-toggle="dropdown">
            <span class="lang-selected">
              <img class="lang-flag" src="../doc/images/flags/united-kingdom.png" alt="English">
            </span>
          </a>
          ...
          <ul class="head-list dropdown-menu">
            ...
            <li>
              <!--France-->
              <a href="#">
                <img class="lang-flag" src="../doc/images/flags/france.png" alt="France">
            ...
            <li>
              <!--Germany-->
              <a href="#">
                <img class="lang-flag" src="../doc/images/flags/germany.png" alt="Germany">
            ...
            <li>
              <!--Italy-->
              <a href="#">
                <img class="lang-flag" src="../doc/images/flags/italy.png" alt="Italy">
            ...
            <li>
              <!--Spain-->
              <a href="#">
                <img class="lang-flag" src="../doc/images/flags/spain.png" alt="Spain">
        ...
        <li id="dropdown-user" class="dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-md dropdown-menu-right panel-default">
            ...
            <div class="pad-all text-right">
              <a href="/auth/developer/logout" class="btn btn-primary">
