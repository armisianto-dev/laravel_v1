    ...
    <section class="content">
      <div class="col-md-12">
        <div class="panel panel-default">
          ...
          <form class="form-horizontal mar-top" action="/sistem/groups/update/{{ $group_id }}" method="post">
            {{ csrf_field() }}
            <div class="panel-body">
              ...
              <div class="form-group">
                ...
                <div class="col-md-7">
                  <input type="text" name="group_id" maxlength="2" value="{{ $result->group_id }}" class="form-control" />
