    ...
    <section class="content">
      <div class="col-md-12">
        <div class="panel panel-default">
          ...
          <form class="form-horizontal mar-top" action="/sistem/groups/update/{{ str_pad($group_id,2,'0',STR_PAD_LEFT) }}" method="post">
            {{ csrf_field() }}
            <div class="panel-body">
              ...
              <div class="form-group">
                ...
                <div class="col-md-7">
                  <input type="text" name="group_id" maxlength="2" value="{{ str_pad($result->group_id,2,'0',STR_PAD_LEFT) }}" class="form-control" />
              ...
              <div class="form-group">
                ...
                <div class="col-md-7">
                  <input type="text" name="group_name" maxlength="50" value="{{ $result->group_name }}" class="form-control" />
                  <small class="help-block text-danger">Wajib diisi.</small>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-md-7">
                  <textarea name="group_desc" rows="4" class="form-control" maxlength="100">{{ $result->group_desc }}</textarea>
                </div>
              </div>
            </div>
