    ...
    <section class="content">
      <div class="col-md-12">
        <div class="panel panel-default">
          ...
          <form class="form-horizontal mar-top" action="/sistem/roles/insert" method="post">
            {{ csrf_field() }}
            <div class="panel-body">
                ...
                <div class="col-md-7">
                  <select class="form-control" name="group_id" id="group_id" data-placeholder="Pilih Group">
                    ...
                    @if (count($rs_group) > 0)
                      ...
                      <option value="{{ str_pad($group->group_id,2,'0',STR_PAD_LEFT) }}">{{ $group->group_name }}</option>
                      @endforeach
                    @endif
                  </select>
              ...
              <div class="form-group">
                ...
                <div class="col-md-7">
                  <input type="text" name="role_nm" maxlength="100" value="" class="form-control" />
                  <small class="help-block text-danger">Wajib diisi.</small>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-md-7">
                  <textarea name="role_desc" rows="4" class="form-control" maxlength="100"></textarea>
                </div>
              </div>
              <div class="form-group">
                <label class="col-md-3 control-label">Default Page</label>
                <div class="col-md-7">
                  <input type="text" name="default_page" maxlength="50" value="" class="form-control" />
                  <small class="help-block text-danger">Wajib diisi.</small>
                </div>
              </div>
            </div>
