    ...
    <section class="content">
      <div class="col-md-12">
        <div class="panel panel-default">
          ...
          <form class="form-horizontal mar-top" action="/sistem/users/update/{{ $user_id }}" method="post">
            {{ csrf_field() }}
            <div class="panel-body">
                ...
                <div class="col-md-7">
                  <select class="form-control" name="role_id" id="role_id" data-placeholder="Pilih Role">
                    ...
                    @if (count($rs_role) > 0)
                      ...
                      <option value="{{ str_pad($role->role_id,5,'0',STR_PAD_LEFT) }}" @if (str_pad($role->role_id,5,'0',STR_PAD_LEFT) == str_pad($result->role_id,5,'0',STR_PAD_LEFT)) selected="" @endif>{{ $role->role_nm }}</option>
                      @endforeach
                    @endif
                  </select>
              ...
              <div class="form-group">
                ...
                <div class="col-md-7">
                  <input type="text" name="user_alias" maxlength="50" value="{{ $result->user_alias }}" class="form-control" />
                  <small class="help-block text-danger">Wajib diisi.</small>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-md-7">
                  <input type="text" name="user_mail" maxlength="50" value="{{ $result->user_mail }}" class="form-control" />
                  <small class="help-block text-danger">Wajib diisi.</small>
                </div>
              </div>
              <div class="form-group">
